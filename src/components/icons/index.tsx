...
/** Lucide: crown (https://lucide.dev/icons/crown) — preside */
...
/** Lucide: users (https://lucide.dev/icons/users) — conduct */
...
/** Lucide: music (https://lucide.dev/icons/music) — lead_music */
export const MusicIcon = ({ size = 24, color = 'currentColor' }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
      d="M9 18V5l12-2v13"
      stroke={color}
...
/** Lucide: piano (https://lucide.dev/icons/piano) — play_piano */
export const PianoIcon = ({ size = 24, color = 'currentColor' }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
      d="M18.5 8c-1.4 0-2.6-.8-3.2-2A6.87 6.87 0 0 0 2 9v11a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a1 1 0 0 0-1-1z"
      stroke={color}
      strokeWidth={2}
      strokeLinecap="round"
      strokeLinejoin="round"
...
/** Lucide: badge-check (https://lucide.dev/icons/badge-check) — be_recognized */
export const BadgeCheckIcon = ({ size = 24, color = 'currentColor' }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
...
/** Lucide: scroll-text (https://lucide.dev/icons/scroll-text) — "text to read" */
export const ScrollTextIcon = ({ size = 24, color = 'currentColor' }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
      d="M15 12h-5"
      stroke={color}
...
/** Lucide: phone (https://lucide.dev/icons/phone) */
...
/** Lucide: send (https://lucide.dev/icons/send) — paper plane. */
export const SendIcon = ({ size = 24, color = 'currentColor' }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path d="M22 2 11 13" stroke={color} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" fill="none" />
    <Path d="M22 2 15 22 11 13 2 9 22 2z" stroke={color} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" fill="none" />
  </Svg>
);
